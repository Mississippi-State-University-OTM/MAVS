...
*/
#ifndef OUSTER_OS1_16
#define OUSTER_OS1_16
 ...
 * \class OusterOS1_16
 *
 * Ouster OS1-16 beam sensor, see
 * https://www.ouster.io/product-os1/
 *
 * \author Chris Goodin
 *
 * \date 8/31/2022
 */
class OusterOS1_16 : public Lidar{
 public:
  /// OusterOS1_16 Constructor
  OusterOS1_16();
  ...
  /**
	 ...
	 */
  OusterOS1_16(float rot_rate, int mode){SetRotationRate(rot_rate, mode);}
  ...
  /// OusterOS1_16 copy contstructor
  OusterOS1_16(const OusterOS1_16 &s){
