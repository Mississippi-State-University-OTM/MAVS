 ...
 * \date 1/22/2019
 */
class OusterOS1 : public Lidar{
 public:
  /// OusterOS1 Constructor
  OusterOS1();
  ...
  /**
	 ...
	 */
  OusterOS1(float rot_rate, int mode){SetRotationRate(rot_rate, mode);}
  ...
  /// OusterOS1 copy contstructor
  OusterOS1(const OusterOS1 &s){
