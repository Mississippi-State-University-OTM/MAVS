...
#mavs_scenefile = "/scenes/brownfield_scene_veg_distribution.json"
...
hd_cam = mavs_interface.MavsPathTraceCamera('high', 50, 10, 0.55)
hd_cam.SetPose([0.0, 0.0, 2.0],[1.0, 0.0, 0.0, 0.0])
...
while True:
    ...
    if (hd_render):
        ...
        hd_cam.SaveCameraImage("snow.bmp")
        hd_render = False
