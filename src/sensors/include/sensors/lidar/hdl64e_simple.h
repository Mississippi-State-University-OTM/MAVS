...
*/
#ifndef HDL_64_E_SIMPLE
#define HDL_64_E_SIMPLE
 ...
 * \class Hdl64ESimple
 *
 * Velodyne HDL64E sensor, simplified so there's no upper and lower block.
 *
 * \author Chris Goodin
 *
 * \date 6/28/2019
 */
class Hdl64ESimple : public Lidar{
 public:
  /// Constructor
  Hdl64ESimple();

  /**
  * Constructor with rep rate between 5 and 20 Hz specified
  **/
  Hdl64ESimple(float rep_rate);
  ...
  Hdl64ESimple(const Hdl64ESimple &s){
